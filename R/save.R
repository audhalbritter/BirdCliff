...
# Main MS
tar_load(trait_plot)
ggsave("output/trait_plot.jpg", trait_plot, dpi = 300, height = 5, width = 8, bg = "white")
...
ggsave("output/trait_ordination_plot.jpg", trait_ordination_plot, dpi = 300, height = 4, width = 8, bg = "white")
