...
# correlations
get_trait_correlations <- function(dat) {
  ...
  correlations = cors(trait_table) %>%
    ...
    mutate(trait1 = recode(trait1,
           ...
           trait2 = recode(trait2,
                           ...
                           SLA_cm2_g = "SLA",
                           Thickness_mm_log = "Thick"),
           trait1 = factor(trait1, levels = c("Height", "Dry", "Area", "Thick", "LDMC", "SLA", "C", "N", "P", "CN", "NP", "dC13", "dN15")),
           trait2 = factor(trait2, levels = c("Height", "Dry", "Area", "Thick", "LDMC", "SLA", "C", "N", "P", "CN", "NP", "dC13", "dN15")))
